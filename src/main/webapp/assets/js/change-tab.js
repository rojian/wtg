// JavaScript Document
	  function tabflash(i){
		     ...
		     for(j=1;j<=manage;j++){
				   ...
				   document.getElementById("tab"+j).style.background="url(/assets/img/icon_01_26.jpg)";
				   $("#text"+i+" a:eq(0)").css("color","#ff7e00")
				   $("#text"+i+" a:eq(13)").css("color","#ff7e00")
				   $("#text"+i+" img:eq(0)").attr("src","/assets/img/icon_01_42.jpg");
				   $("#text"+i+" img:eq(13)").attr("src","/assets/img/icon_01_42.jpg");
				 }
				   document.getElementById("text"+i).style.display="block";
				   document.getElementById("tab"+i).style.background="url(/assets/img/icon_01_25.jpg)";
		  }
	  ...
	  function bdflash(i){
		     ...
		     for(j=1;j<=cul;j++){
				   ...
				   document.getElementById("bd"+j).style.background="url(/assets/img/icon_01_35.jpg)";
				   $("#cul"+i+" li:eq(4)").css("border-bottom","#fff")
				   $("#cul"+i+" li:eq(5)").css("border-bottom","#fff")
				 }
				   document.getElementById("cul"+i).style.display="block";
				   document.getElementById("bd"+i).style.background="url(/assets/img/icon_01_31.jpg)";
		  }
